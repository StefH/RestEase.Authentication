...
internal class CustomHttpLoggingHandler<T>(ILogger<CustomHttpLoggingHandler<T>> logger, IOptions<AuthenticatedRestEaseOptions<T>> options) : DelegatingHandler where T : class
{
